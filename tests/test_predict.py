...
from tests.common import (CONAN_GIF_VIDEO_URL, DOG_IMAGE_URL, GENERAL_MODEL_ID,
                          NON_EXISTING_IMAGE_URL, RED_TRUCK_IMAGE_FILE_PATH, TOY_VIDEO_FILE_PATH,
                          both_channels, metadata, raise_on_failure)
