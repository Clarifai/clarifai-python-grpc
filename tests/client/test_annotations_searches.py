...
def test_post_annotations_searches(channel):
  ...
  palm_search_response = stub.PostConceptsSearches(
    service_pb2.PostConceptsSearchesRequest(concept_query=resources_pb2.ConceptQuery(name="palm")),
    metadata=metadata(),
  )
            ...
            data=resources_pb2.Data(
              regions=[
                resources_pb2.Region(
                  ...
                  data=resources_pb2.Data(
                    concepts=[resources_pb2.Concept(id=palm_concept_id, value=1)]
                  ),
                ),
              ]
            ),
            ...
            data=resources_pb2.Data(
              regions=[
                resources_pb2.Region(
                  ...
                  data=resources_pb2.Data(
                    concepts=[resources_pb2.Concept(id=water_concept_id, value=1)]
                  ),
                ),
              ]
            ),
