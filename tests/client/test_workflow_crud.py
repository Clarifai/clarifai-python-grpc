...
def test_post_patch_get_delete_workflow(channel_key):
    ...
    workflow_id = "mod-and-general-" + uuid.uuid4().hex[:15]
            ...
            workflows=[
                resources_pb2.Workflow(
                    ...
                    nodes=[
                        ...
                        resources_pb2.WorkflowNode(
                            id="the-moderation-node",
                            # This is the public moderation model.
                            model=resources_pb2.Model(
                                id=MODERATION_MODEL_ID,
                                model_version=resources_pb2.ModelVersion(
    ...
    # Note(zeiler): crazy we were testing 2016 model version.
    # try:
