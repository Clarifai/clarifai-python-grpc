        ...
        searches=[
          Search(
            query=Query(
              filters=[
                Filter(
                  annotation=Annotation(data=Data(concepts=[Concept(id=concept_id, value=1)]))
                )
              ]
            )
          )
        ...
        searches=[
          Search(
            query=Query(
              filters=[
                Filter(
                  annotation=Annotation(data=Data(concepts=[Concept(name=concept_name, value=1)]))
                )
              ]
            )
          )
      ...
      PostInputsSearchesRequest(
        searches=[
          Search(
            query=Query(
              ranks=[
                Rank(annotation=Annotation(data=Data(concepts=[Concept(name="dog", value=1)])))
              ]
            )
          )
        ],
      ...
      PostInputsSearchesRequest(
        searches=[
          Search(
            query=Query(
              ranks=[
                Rank(annotation=Annotation(data=Data(concepts=[Concept(name="狗", value=1)])))
              ],
              language="zh",
            ),
          )
    ...
    response = stub.PostInputsSearches(
      PostInputsSearchesRequest(
        searches=[
          Search(
            query=Query(
              ranks=[Rank(annotation=Annotation(data=Data(image=Image(url=DOG_IMAGE_URL))))]
            )
          )
        ],
        pagination=service_pb2.Pagination(page=1, per_page=1000),
    ...
    response = stub.PostInputsSearches(
      PostInputsSearchesRequest(
        searches=[
          Search(
            query=Query(
              ranks=[Rank(annotation=Annotation(data=Data(image=Image(base64=url_bytes))))]
            )
          )
        ],
        pagination=service_pb2.Pagination(page=1, per_page=1000),
    ...
    response = stub.PostInputsSearches(
      PostInputsSearchesRequest(
        searches=[
          Search(
            query=Query(
              filters=[Filter(annotation=Annotation(data=Data(metadata=search_metadata)))]
            )
          )
        ],
        pagination=service_pb2.Pagination(page=1, per_page=1000),
                  ...
                  annotation=Annotation(
                    data=Data(
                      geo=resources_pb2.Geo(
                        geo_point=resources_pb2.GeoPoint(longitude=43, latitude=56),
                        geo_limit=resources_pb2.GeoLimit(value=1000, type="withinKilometers"),
                      )
                    )
                  )
                )
                      ...
                      geo=resources_pb2.Geo(
                        geo_box=[
                          resources_pb2.GeoBoxedPoint(
                            geo_point=resources_pb2.GeoPoint(longitude=43, latitude=54)
                          ),
                          resources_pb2.GeoBoxedPoint(
      ...
      PostInputsSearchesRequest(
        searches=[
          Search(
            query=Query(
              ranks=[
                Rank(annotation=Annotation(data=Data(image=Image(url=DOG_IMAGE_URL)))),
              ],
              filters=[
                Filter(
                  annotation=Annotation(
        ...
        inputs=[
          resources_pb2.Input(
            data=resources_pb2.Data(
              ...
              concepts=[resources_pb2.Concept(id=my_concept_id, name=my_concept_name, value=1)],
              metadata=image_metadata,
              geo=resources_pb2.Geo(geo_point=resources_pb2.GeoPoint(longitude=44, latitude=55)),
            ),
          )
        ]
      ),
