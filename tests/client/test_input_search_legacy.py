      ...
      service_pb2.PostSearchesRequest(
        query=resources_pb2.Query(
          ands=[
            resources_pb2.And(
              output=resources_pb2.Output(
                data=resources_pb2.Data(concepts=[resources_pb2.Concept(name="dog", value=1)])
              )
            )
          ]
        ),
      ...
      service_pb2.PostSearchesRequest(
        query=resources_pb2.Query(
          ands=[
            resources_pb2.And(
              output=resources_pb2.Output(
                data=resources_pb2.Data(concepts=[resources_pb2.Concept(name="狗", value=1)])
              )
            )
          ],
          language="zh",
      ...
      service_pb2.PostSearchesRequest(
        query=resources_pb2.Query(
          ands=[
            resources_pb2.And(
              output=resources_pb2.Output(
                data=resources_pb2.Data(concepts=[resources_pb2.Concept(name="犬", value=1)])
              )
            )
          ],
          language="ja",
        ...
        query=resources_pb2.Query(
          ands=[
            resources_pb2.And(
              output=resources_pb2.Output(
                input=resources_pb2.Input(
                  data=resources_pb2.Data(image=resources_pb2.Image(base64=url_bytes))
                )
              )
            )
          ]
      ...
      service_pb2.PatchAnnotationsRequest(
        ...
        annotations=[
          resources_pb2.Annotation(
            ...
            input_id=input1.id,
            data=resources_pb2.Data(concepts=[resources_pb2.Concept(id=my_concept_id, value=1)]),
          ),
          resources_pb2.Annotation(
