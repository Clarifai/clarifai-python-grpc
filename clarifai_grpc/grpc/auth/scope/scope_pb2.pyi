...
class S(object):
    ...
    Predict_Feedback = typing___cast(SValue, 29)
    Search = typing___cast(SValue, 3)
    Search_Feedback = typing___cast(SValue, 28)
    ...
    PasswordHistory_Add = typing___cast(SValue, 60)
    PasswordHistory_Get = typing___cast(SValue, 61)
    PasswordHistory_Delete = typing___cast(SValue, 62)
    Notifications_Get = typing___cast(SValue, 64)
    Notifications_Add = typing___cast(SValue, 65)
    Notifications_Delete = typing___cast(SValue, 66)
    ...
    UserFeatureConfigs_Add = typing___cast(SValue, 72)
    UserFeatureConfigs_Delete = typing___cast(SValue, 73)
undef = typing___cast(SValue, 0)
All = typing___cast(SValue, 1)
Predict = typing___cast(SValue, 2)
Predict_Feedback = typing___cast(SValue, 29)
