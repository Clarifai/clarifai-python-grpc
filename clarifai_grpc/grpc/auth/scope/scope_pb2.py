...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _S.values_by_name["InputsAddJobs_Add"]._options = None
  _S.values_by_name["InputsAddJobs_Add"]._serialized_options = b'\370\233\'~'
