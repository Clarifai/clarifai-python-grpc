...
class PostModulesRequest(google.protobuf.message.Message):
    ...
    def modules(
        ...
        proto.clarifai.api.resources_pb2.Module
    ]:
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "modules", b"modules", "user_app_id", b"user_app_id"
        ],
    ) -> None: ...
...
class PatchModulesRequest(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "action", b"action", "modules", b"modules", "user_app_id", b"user_app_id"
        ],
    ) -> None: ...
...
class SingleModuleResponse(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing_extensions.Literal["module", b"module", "status", b"status"]
    ) -> builtins.bool: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["module", b"module", "status", b"status"]
    ) -> None: ...
...
class MultiModuleResponse(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["modules", b"modules", "status", b"status"]
    ) -> None: ...
...
class PostModuleVersionsRequest(google.protobuf.message.Message):
    ...
    def module_versions(
        ...
        proto.clarifai.api.resources_pb2.ModuleVersion
    ]:
        """This allows you to create one or more module by posting it to the API."""
    def __init__(
        self,
        *,
        user_app_id: proto.clarifai.api.resources_pb2.UserAppIDSet | None = ...,
        module_id: builtins.str = ...,
        module_versions: collections.abc.Iterable[proto.clarifai.api.resources_pb2.ModuleVersion]
        | None = ...,
    ) -> None: ...
    def HasField(
        self, field_name: typing_extensions.Literal["user_app_id", b"user_app_id"]
...
class DeleteModuleVersionsRequest(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "ids", b"ids", "module_id", b"module_id", "user_app_id", b"user_app_id"
        ],
    ) -> None: ...
...
class SingleModuleVersionResponse(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "module_version", b"module_version", "status", b"status"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class MultiModuleVersionResponse(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "module_versions", b"module_versions", "status", b"status"
        ],
    ) -> None: ...
...
class SingleModuleVersionUsageCountResponse(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal["status", b"status", "usage_count", b"usage_count"],
    ) -> None: ...
...
class PostInstalledModuleVersionsRequest(google.protobuf.message.Message):
    ...
    def user_app_id(self) -> proto.clarifai.api.resources_pb2.UserAppIDSet: ...
    @property
    def installed_module_versions(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[
        proto.clarifai.api.resources_pb2.InstalledModuleVersion
    ]:
        """This allows you to create one or more module by posting it to the API."""
    def __init__(
        self,
        *,
        user_app_id: proto.clarifai.api.resources_pb2.UserAppIDSet | None = ...,
        installed_module_versions: collections.abc.Iterable[
            proto.clarifai.api.resources_pb2.InstalledModuleVersion
        ]
        | None = ...,
    ) -> None: ...
...
class SingleInstalledModuleVersionResponse(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        status: proto.clarifai.api.status.status_pb2.Status | None = ...,
        installed_module_version: proto.clarifai.api.resources_pb2.InstalledModuleVersion
        | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "installed_module_version", b"installed_module_version", "status", b"status"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class MultiInstalledModuleVersionResponse(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "installed_module_versions", b"installed_module_versions", "status", b"status"
        ],
    ) -> None: ...
