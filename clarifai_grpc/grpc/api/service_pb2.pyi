...
class PostModelOutputsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["enable_log_summary_on_error", b"enable_log_summary_on_error", "inputs", b"inputs", "model", b"model", "model_id", b"model_id", "runner_selector", b"runner_selector", "use_predict_cache", b"use_predict_cache", "user_app_id", b"user_app_id", "version_id", b"version_id"]) -> None: ...
...
class ListKeysRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["user_app_id", b"user_app_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["endpoints", b"endpoints", "not_expired", b"not_expired", "page", b"page", "per_page", b"per_page", "scopes", b"scopes", "type", b"type", "user_app_id", b"user_app_id"]) -> None: ...
...
class MultiOutputResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["runner_selector", b"runner_selector", "status", b"status"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["outputs", b"outputs", "runner_selector", b"runner_selector", "status", b"status"]) -> None: ...
...
class GetWorkflowRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["user_app_id", b"user_app_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["additional_fields", b"additional_fields", "user_app_id", b"user_app_id", "workflow_id", b"workflow_id"]) -> None: ...
...
class ListDeploymentsRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["user_app_id", b"user_app_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["compute_cluster_id", b"compute_cluster_id", "model_version_ids", b"model_version_ids", "nodepool_id", b"nodepool_id", "page", b"page", "per_page", b"per_page", "user_app_id", b"user_app_id", "workflow_version_ids", b"workflow_version_ids"]) -> None: ...
...
class ListWorkflowVersionEvaluationDataRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["user_app_id", b"user_app_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["page", b"page", "per_page", b"per_page", "user_app_id", b"user_app_id", "workflow_id", b"workflow_id", "workflow_version_evaluation_id", b"workflow_version_evaluation_id", "workflow_version_id", b"workflow_version_id"]) -> None: ...
...
class MultiListWorkflowVersionEvaluationDataResponse(google.protobuf.message.Message):
    ...
    def status(self) -> proto.clarifai.api.status.status_pb2.Status: ...
    @property
    def workflow_version_evaluation_data(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[proto.clarifai.api.resources_pb2.WorkflowVersionEvaluationData]: ...
    def __init__(
        self,
        *,
        status: proto.clarifai.api.status.status_pb2.Status | None = ...,
        workflow_version_evaluation_data: collections.abc.Iterable[proto.clarifai.api.resources_pb2.WorkflowVersionEvaluationData] | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["status", b"status"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["status", b"status", "workflow_version_evaluation_data", b"workflow_version_evaluation_data"]) -> None: ...

global___MultiListWorkflowVersionEvaluationDataResponse = MultiListWorkflowVersionEvaluationDataResponse
...
class GetPipelineRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["user_app_id", b"user_app_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["pipeline_id", b"pipeline_id", "user_app_id", b"user_app_id"]) -> None: ...
...
class PostPipelinesRequest(google.protobuf.message.Message):
    ...
    def user_app_id(self) -> proto.clarifai.api.resources_pb2.UserAppIDSet: ...
    @property
    def pipelines(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[proto.clarifai.api.resources_pb2.Pipeline]: ...
    def __init__(
        self,
        *,
        user_app_id: proto.clarifai.api.resources_pb2.UserAppIDSet | None = ...,
        pipelines: collections.abc.Iterable[proto.clarifai.api.resources_pb2.Pipeline] | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["user_app_id", b"user_app_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["pipelines", b"pipelines", "user_app_id", b"user_app_id"]) -> None: ...
...
class PatchPipelinesRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["user_app_id", b"user_app_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["action", b"action", "pipelines", b"pipelines", "user_app_id", b"user_app_id"]) -> None: ...
...
class DeletePipelinesRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["user_app_id", b"user_app_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["pipeline_ids", b"pipeline_ids", "user_app_id", b"user_app_id"]) -> None: ...
...
class SinglePipelineResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["pipeline", b"pipeline", "status", b"status"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["pipeline", b"pipeline", "status", b"status"]) -> None: ...
...
class MultiPipelineResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["status", b"status"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["pipelines", b"pipelines", "status", b"status"]) -> None: ...
...
class GetPipelineVersionRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["user_app_id", b"user_app_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["pipeline_id", b"pipeline_id", "pipeline_version_id", b"pipeline_version_id", "user_app_id", b"user_app_id"]) -> None: ...
...
class ListPipelineVersionsRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["user_app_id", b"user_app_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["page", b"page", "per_page", b"per_page", "pipeline_id", b"pipeline_id", "user_app_id", b"user_app_id"]) -> None: ...
...
class PatchPipelineVersionsRequest(google.protobuf.message.Message):
    ...
    @property
    def pipeline_versions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[proto.clarifai.api.resources_pb2.PipelineVersion]:
        """Patch these versions"""
    action: builtins.str
    """The action to perform on the patched objects
    For now actions 'merge', 'overwrite', and 'remove' are supported
    ...
    def __init__(
        ...
        *,
        user_app_id: proto.clarifai.api.resources_pb2.UserAppIDSet | None = ...,
        pipeline_id: builtins.str = ...,
        pipeline_versions: collections.abc.Iterable[proto.clarifai.api.resources_pb2.PipelineVersion] | None = ...,
        action: builtins.str = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["user_app_id", b"user_app_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["action", b"action", "pipeline_id", b"pipeline_id", "pipeline_versions", b"pipeline_versions", "user_app_id", b"user_app_id"]) -> None: ...
...
class DeletePipelineVersionsRequest(google.protobuf.message.Message):
    ...
    @property
    def pipeline_version_ids(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.str]: ...
    def __init__(
        self,
        *,
        user_app_id: proto.clarifai.api.resources_pb2.UserAppIDSet | None = ...,
    ...
    def HasField(self, field_name: typing_extensions.Literal["user_app_id", b"user_app_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["pipeline_id", b"pipeline_id", "pipeline_version_ids", b"pipeline_version_ids", "user_app_id", b"user_app_id"]) -> None: ...
...
class SinglePipelineVersionResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["pipeline_version", b"pipeline_version", "status", b"status"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["pipeline_version", b"pipeline_version", "status", b"status"]) -> None: ...
...
class MultiPipelineVersionResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["status", b"status"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["pipeline_versions", b"pipeline_versions", "status", b"status"]) -> None: ...
...
class GetPipelineVersionRunRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["user_app_id", b"user_app_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["pipeline_id", b"pipeline_id", "pipeline_version_id", b"pipeline_version_id", "pipeline_version_run_id", b"pipeline_version_run_id", "user_app_id", b"user_app_id"]) -> None: ...
...
class ListPipelineVersionRunsRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["user_app_id", b"user_app_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["compute_cluster_id", b"compute_cluster_id", "nodepool_id", b"nodepool_id", "page", b"page", "per_page", b"per_page", "pipeline_id", b"pipeline_id", "pipeline_version_id", b"pipeline_version_id", "status_codes", b"status_codes", "user_app_id", b"user_app_id"]) -> None: ...
...
class PostPipelineVersionRunsRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["runner_selector", b"runner_selector", "user_app_id", b"user_app_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["pipeline_id", b"pipeline_id", "pipeline_version_id", b"pipeline_version_id", "pipeline_version_runs", b"pipeline_version_runs", "runner_selector", b"runner_selector", "user_app_id", b"user_app_id"]) -> None: ...
...
class PatchPipelineVersionRunsRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["user_app_id", b"user_app_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["action", b"action", "pipeline_id", b"pipeline_id", "pipeline_version_id", b"pipeline_version_id", "pipeline_version_runs", b"pipeline_version_runs", "user_app_id", b"user_app_id"]) -> None: ...
...
class SinglePipelineVersionRunResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["pipeline_version_run", b"pipeline_version_run", "status", b"status"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["pipeline_version_run", b"pipeline_version_run", "status", b"status"]) -> None: ...
...
class MultiPipelineVersionRunResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["status", b"status"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["pipeline_version_runs", b"pipeline_version_runs", "status", b"status"]) -> None: ...
...
class PostPipelineStepsRequest(google.protobuf.message.Message):
    ...
    def user_app_id(self) -> proto.clarifai.api.resources_pb2.UserAppIDSet: ...
    @property
    def pipeline_steps(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[proto.clarifai.api.resources_pb2.PipelineStep]: ...
    def __init__(
        self,
        *,
        user_app_id: proto.clarifai.api.resources_pb2.UserAppIDSet | None = ...,
        pipeline_steps: collections.abc.Iterable[proto.clarifai.api.resources_pb2.PipelineStep] | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["user_app_id", b"user_app_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["pipeline_steps", b"pipeline_steps", "user_app_id", b"user_app_id"]) -> None: ...
...
class MultiPipelineStepResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["status", b"status"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["pipeline_steps", b"pipeline_steps", "status", b"status"]) -> None: ...
...
class ListPipelineStepVersionsRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["user_app_id", b"user_app_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["page", b"page", "per_page", b"per_page", "pipeline_step_id", b"pipeline_step_id", "status_codes", b"status_codes", "user_app_id", b"user_app_id"]) -> None: ...
...
class MultiPipelineStepVersionResponse(google.protobuf.message.Message):
    ...
    def status(self) -> proto.clarifai.api.status.status_pb2.Status:
        """The status of the request"""
    @property
    def pipeline_step_versions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[proto.clarifai.api.resources_pb2.PipelineStepVersion]:
        """The pipeline step versions that were requested"""
    def __init__(
        self,
        *,
        status: proto.clarifai.api.status.status_pb2.Status | None = ...,
        pipeline_step_versions: collections.abc.Iterable[proto.clarifai.api.resources_pb2.PipelineStepVersion] | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["status", b"status"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["pipeline_step_versions", b"pipeline_step_versions", "status", b"status"]) -> None: ...
...
class PostPipelineStepVersionsUploadResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["status", b"status"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["bytes_remaining", b"bytes_remaining", "pipeline_step_version_id", b"pipeline_step_version_id", "status", b"status"]) -> None: ...
...
class PostPipelineStepVersionsUploadConfig(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["pipeline_step_version", b"pipeline_step_version", "user_app_id", b"user_app_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["pipeline_step_id", b"pipeline_step_id", "pipeline_step_version", b"pipeline_step_version", "storage_request_size", b"storage_request_size", "total_size", b"total_size", "user_app_id", b"user_app_id"]) -> None: ...
...
class GetPipelineStepRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["user_app_id", b"user_app_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["pipeline_step_id", b"pipeline_step_id", "user_app_id", b"user_app_id"]) -> None: ...
...
class SinglePipelineStepResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["pipeline_step", b"pipeline_step", "status", b"status"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["pipeline_step", b"pipeline_step", "status", b"status"]) -> None: ...
...
class GetPipelineStepVersionRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["user_app_id", b"user_app_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["pipeline_step_id", b"pipeline_step_id", "pipeline_step_version_id", b"pipeline_step_version_id", "user_app_id", b"user_app_id"]) -> None: ...
...
class SinglePipelineStepVersionResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["pipeline_step_version", b"pipeline_step_version", "status", b"status"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["pipeline_step_version", b"pipeline_step_version", "status", b"status"]) -> None: ...
