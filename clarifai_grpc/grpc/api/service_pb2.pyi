...
@typing_extensions.final
class MCPRequest(google.protobuf.message.Message):
    ...
    JSONRPC_FIELD_NUMBER: builtins.int
    ID_FIELD_NUMBER: builtins.int
    ...
    def HasField(
        self,
        field_name: typing_extensions.Literal["params", b"params", "user_app_id", b"user_app_id"],
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
...
global___MCPRequest = MCPRequest

@typing_extensions.final
class MCPError(google.protobuf.message.Message):
    """An MCP error."""
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "code", b"code", "data", b"data", "message", b"message"
        ],
    ) -> None: ...

global___MCPError = MCPError

@typing_extensions.final
class SingleMCPResponse(google.protobuf.message.Message):
    ...
    @property
    def error(self) -> global___MCPError:
    ...
    def __init__(
        ...
        *,
        ...
        error: global___MCPError | None = ...,
        status: proto.clarifai.api.status.status_pb2.Status | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "error", b"error", "result", b"result", "status", b"status"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
global___SingleMCPResponse = SingleMCPResponse
