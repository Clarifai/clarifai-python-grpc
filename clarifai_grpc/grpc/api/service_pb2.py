...
_V2 = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=_MULTIAPPRESPONSE,
    serialized_options=b'\202\323\344\223\002D\022-/v2/users/{user_app_id.user_id}/apps/searchesZ\023\022\021/v2/apps/searches\230\234\'\005\220\234\'-\220\234\'\023',
  ),
  _descriptor.MethodDescriptor(
