...
_POSTMODELVERSIONSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='train_query', full_name='clarifai.api.PostModelVersionsRequest.train_query', index=4,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='test_query', full_name='clarifai.api.PostModelVersionsRequest.test_query', index=5,
...
_POSTMODELVERSIONSREQUEST.fields_by_name['train_query'].message_type = proto_dot_clarifai_dot_api_dot_resources__pb2._SEARCH
_POSTMODELVERSIONSREQUEST.fields_by_name['test_query'].message_type = proto_dot_clarifai_dot_api_dot_resources__pb2._SEARCH
