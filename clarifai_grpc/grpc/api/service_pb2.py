...
_V2 = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=_MULTIAPPRESPONSE,
    serialized_options=b'\202\323\344\223\002J\"-/v2/users/{user_app_id.user_id}/apps/searches:\001*Z\026\"\021/v2/apps/searches:\001*\230\234\'\005\220\234\'-\220\234\'\023',
  ),
  _descriptor.MethodDescriptor(
