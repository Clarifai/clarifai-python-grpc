...
class TestProto(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["one_of_field", b"one_of_field"]) -> typing_extensions.Literal["string_oneof", "bool_oneof", "message_oneof"] | None: ...
