...
class TimeOfDayRange(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["end", b"end", "is_end_inclusive", b"is_end_inclusive", "is_start_inclusive", b"is_start_inclusive", "start", b"start"]) -> None: ...
