...
class Annotation(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["annotation_info", b"annotation_info", "consensus_info", b"consensus_info", "created_at", b"created_at", "data", b"data", "modified_at", b"modified_at", "status", b"status", "worker", b"worker"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["annotation_info", b"annotation_info", "consensus_info", b"consensus_info", "created_at", b"created_at", "data", b"data", "embed_model_version_id", b"embed_model_version_id", "id", b"id", "input_id", b"input_id", "input_level", b"input_level", "model_version_id", b"model_version_id", "modified_at", b"modified_at", "status", b"status", "task_id", b"task_id", "trusted", b"trusted", "user_id", b"user_id", "worker", b"worker"]) -> None: ...
...
class Image(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["allow_duplicate_url", b"allow_duplicate_url", "base64", b"base64", "decoded_bytes", b"decoded_bytes", "hosted", b"hosted", "hosted_image_info", b"hosted_image_info", "image_info", b"image_info", "url", b"url"]) -> None: ...
...
class ImageInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["color_mode", b"color_mode", "format", b"format", "height", b"height", "mode", b"mode", "width", b"width"]) -> None: ...
...
class Model(google.protobuf.message.Message):
    ...
    class _BillingTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Model._BillingType.ValueType], builtins.type):  # noqa: F821
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class WorkflowResult(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["created_at", b"created_at", "input", b"input", "status", b"status"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["created_at", b"created_at", "id", b"id", "input", b"input", "outputs", b"outputs", "status", b"status", "suppress_output", b"suppress_output"]) -> None: ...
...
class Task(google.protobuf.message.Message):
    ...
    class _TaskPriorityEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Task._TaskPriority.ValueType], builtins.type):  # noqa: F821
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class TaskAIAssistant(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["workflow", b"workflow", "workflow_id", b"workflow_id"]) -> None: ...
...
class BulkOperation(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["annotation_search", b"annotation_search", "annotation_source", b"annotation_source", "created_at", b"created_at", "dataset", b"dataset", "input_ids", b"input_ids", "input_source", b"input_source", "last_modified_at", b"last_modified_at", "operation", b"operation", "progress", b"progress", "search", b"search", "status", b"status"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["annotation_search", b"annotation_search", "annotation_source", b"annotation_source", "app_id", b"app_id", "created_at", b"created_at", "created_by", b"created_by", "dataset", b"dataset", "id", b"id", "input_ids", b"input_ids", "input_source", b"input_source", "last_modified_at", b"last_modified_at", "operation", b"operation", "progress", b"progress", "search", b"search", "status", b"status"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["annotation_source", b"annotation_source"]) -> typing_extensions.Literal["annotation_search"] | None: ...
    @typing.overload
...
class Operation(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["add_concepts", b"add_concepts", "add_metadata", b"add_metadata", "add_to_dataset", b"add_to_dataset", "annotation_operation", b"annotation_operation", "delete_annotations", b"delete_annotations", "delete_concepts", b"delete_concepts", "delete_from_dataset", b"delete_from_dataset", "delete_geo", b"delete_geo", "delete_metadata", b"delete_metadata", "operation", b"operation", "overwrite_geo", b"overwrite_geo", "split_into_datasets", b"split_into_datasets"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["add_concepts", b"add_concepts", "add_metadata", b"add_metadata", "add_to_dataset", b"add_to_dataset", "annotation_operation", b"annotation_operation", "delete_annotations", b"delete_annotations", "delete_concepts", b"delete_concepts", "delete_from_dataset", b"delete_from_dataset", "delete_geo", b"delete_geo", "delete_metadata", b"delete_metadata", "operation", b"operation", "overwrite_geo", b"overwrite_geo", "split_into_datasets", b"split_into_datasets"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["annotation_operation", b"annotation_operation"]) -> typing_extensions.Literal["delete_annotations"] | None: ...
    @typing.overload
...
class InstanceType(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["allowed_capacity_types", b"allowed_capacity_types", "cloud_provider", b"cloud_provider", "compute_info", b"compute_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["allowed_capacity_types", b"allowed_capacity_types", "cloud_provider", b"cloud_provider", "compute_info", b"compute_info", "description", b"description", "id", b"id", "price", b"price", "region", b"region"]) -> None: ...
...
class ComputeInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["accelerator_memory", b"accelerator_memory", "accelerator_type", b"accelerator_type", "cpu_limit", b"cpu_limit", "cpu_memory", b"cpu_memory", "cpu_memory_requests", b"cpu_memory_requests", "cpu_requests", b"cpu_requests", "num_accelerators", b"num_accelerators"]) -> None: ...
...
class AutoscaleConfig(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["disable_packing", b"disable_packing", "max_replicas", b"max_replicas", "min_replicas", b"min_replicas", "scale_down_delay_seconds", b"scale_down_delay_seconds", "scale_to_zero_delay_seconds", b"scale_to_zero_delay_seconds", "scale_up_delay_seconds", b"scale_up_delay_seconds", "traffic_history_seconds", b"traffic_history_seconds"]) -> None: ...
...
class Deployment(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["autoscale_config", b"autoscale_config", "created_at", b"created_at", "deploy_latest_version", b"deploy_latest_version", "description", b"description", "id", b"id", "metadata", b"metadata", "modified_at", b"modified_at", "nodepools", b"nodepools", "scheduling_choice", b"scheduling_choice", "user_id", b"user_id", "visibility", b"visibility", "worker", b"worker"]) -> None: ...
...
class WorkflowEvaluationResultSummary(google.protobuf.message.Message):
    ...
    @property
    def evaluation_metric_values(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___EvaluationMetricValue]:
        """The evaluation metrics."""
    def __init__(
        self,
        *,
        evaluation_metric_values: collections.abc.Iterable[global___EvaluationMetricValue] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["evaluation_metric_values", b"evaluation_metric_values"]) -> None: ...
...
class EvaluationMetricValue(google.protobuf.message.Message):
    ...
    @property
    def per_concept_values(self) -> google.protobuf.internal.containers.MessageMap[builtins.str, global___MetricValue]:
    ...
    def __init__(
        ...
        *,
        ...
        explanation: builtins.str = ...,
        per_concept_values: collections.abc.Mapping[builtins.str, global___MetricValue] | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["metric_value", b"metric_value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["evaluation_metric_id", b"evaluation_metric_id", "explanation", b"explanation", "metric_value", b"metric_value", "per_concept_values", b"per_concept_values"]) -> None: ...
...
class InputEvaluationMetricValue(google.protobuf.message.Message):
    ...
    """explanation for the value"""
    @property
    def per_region_values(self) -> google.protobuf.internal.containers.MessageMap[builtins.str, global___MetricValue]:
    ...
    def __init__(
        ...
        *,
        ...
        metric_value: global___MetricValue | None = ...,
        explanation: builtins.str = ...,
        per_region_values: collections.abc.Mapping[builtins.str, global___MetricValue] | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["metric_value", b"metric_value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["evaluation_metric_id", b"evaluation_metric_id", "explanation", b"explanation", "metric_value", b"metric_value", "per_region_values", b"per_region_values"]) -> None: ...
...
class MetricValue(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["float_value", b"float_value", "int_value", b"int_value", "metric_value", b"metric_value", "string_value", b"string_value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["float_value", b"float_value", "int_value", b"int_value", "metric_value", b"metric_value", "string_value", b"string_value"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["metric_value", b"metric_value"]) -> typing_extensions.Literal["string_value", "float_value", "int_value"] | None: ...
...
class WorkflowEvaluationInputResult(google.protobuf.message.Message):
    ...
    @property
    def input_evaluation_metric_values(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___InputEvaluationMetricValue]: ...
    def __init__(
        self,
        *,
        input_evaluation_metric_values: collections.abc.Iterable[global___InputEvaluationMetricValue] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["input_evaluation_metric_values", b"input_evaluation_metric_values"]) -> None: ...
...
class WorkflowVersionEvaluationData(google.protobuf.message.Message):
    ...
    def input(self) -> global___Input: ...
    @property
    def ground_truths(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___Data]: ...
    @property
    def predictions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___Data]: ...
    @property
    ...
    def HasField(self, field_name: typing_extensions.Literal["input", b"input", "workflow_evaluation_sample_result", b"workflow_evaluation_sample_result"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["ground_truths", b"ground_truths", "id", b"id", "input", b"input", "predictions", b"predictions", "workflow_evaluation_sample_result", b"workflow_evaluation_sample_result"]) -> None: ...
...
class ArgoOrchestrationSpec(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["api_version", b"api_version", "spec_json", b"spec_json"]) -> None: ...
...
class PipelineStepInputParam(google.protobuf.message.Message):
    ...
    @property
    def accepted_values(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.str]:
    ...
    def ClearField(self, field_name: typing_extensions.Literal["accepted_values", b"accepted_values", "default_value", b"default_value", "description", b"description", "name", b"name"]) -> None: ...
...
class PipelineStep(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["created_at", b"created_at", "modified_at", b"modified_at", "pipeline_step_version", b"pipeline_step_version", "visibility", b"visibility"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["created_at", b"created_at", "description", b"description", "id", b"id", "modified_at", b"modified_at", "pipeline_step_version", b"pipeline_step_version", "user_id", b"user_id", "visibility", b"visibility"]) -> None: ...
...
class OrchestrationStepSpec(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["argo_orchestration_step_spec", b"argo_orchestration_step_spec", "orchestration", b"orchestration"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["argo_orchestration_step_spec", b"argo_orchestration_step_spec", "orchestration", b"orchestration"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["orchestration", b"orchestration"]) -> typing_extensions.Literal["argo_orchestration_step_spec"] | None: ...
...
class PipelineStepVersion(google.protobuf.message.Message):
    ...
    @property
    def pipeline_step_input_params(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___PipelineStepInputParam]:
    ...
    def __init__(
        ...
        *,
        ...
        pipeline_step_input_params: collections.abc.Iterable[global___PipelineStepInputParam] | None = ...,
        status: proto.clarifai.api.status.status_pb2.Status | None = ...,
    ...
    def HasField(self, field_name: typing_extensions.Literal["build_info", b"build_info", "created_at", b"created_at", "modified_at", b"modified_at", "orchestration_step_spec", b"orchestration_step_spec", "pipeline_step", b"pipeline_step", "pipeline_step_compute_info", b"pipeline_step_compute_info", "status", b"status", "visibility", b"visibility"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["app_id", b"app_id", "build_info", b"build_info", "created_at", b"created_at", "description", b"description", "id", b"id", "modified_at", b"modified_at", "orchestration_step_spec", b"orchestration_step_spec", "pipeline_step", b"pipeline_step", "pipeline_step_compute_info", b"pipeline_step_compute_info", "pipeline_step_input_params", b"pipeline_step_input_params", "status", b"status", "user_id", b"user_id", "visibility", b"visibility"]) -> None: ...
...
class Pipeline(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["created_at", b"created_at", "metadata", b"metadata", "modified_at", b"modified_at", "pipeline_version", b"pipeline_version", "visibility", b"visibility"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["app_id", b"app_id", "created_at", b"created_at", "description", b"description", "id", b"id", "metadata", b"metadata", "modified_at", b"modified_at", "notes", b"notes", "pipeline_version", b"pipeline_version", "user_id", b"user_id", "visibility", b"visibility"]) -> None: ...
...
class PipelineVersionRun(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["created_at", b"created_at", "modified_at", b"modified_at", "orchestration_status", b"orchestration_status", "pipeline_version", b"pipeline_version"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["app_id", b"app_id", "created_at", b"created_at", "id", b"id", "modified_at", b"modified_at", "nodepools", b"nodepools", "orchestration_status", b"orchestration_status", "pipeline_version", b"pipeline_version", "user_id", b"user_id"]) -> None: ...
