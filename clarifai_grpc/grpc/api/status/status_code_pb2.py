...
_STATUSCODE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RPC_UNKNOWN_METHOD', index=171, number=40036,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='EVALUATION_QUEUED', index=198, number=43100,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='EVALUATION_IN_PROGRESS', index=199, number=43101,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='EVALUATION_SUCCESS', index=200, number=43102,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='EVALUATION_FAILED_TO_RETRIEVE_DATA', index=201, number=43103,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='EVALUATION_INVALID_ARGUMENT', index=202, number=43104,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='EVALUATION_FAILED', index=203, number=43105,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='EVALUATION_PENDING', index=204, number=43106,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='EVALUATION_TIMED_OUT', index=205, number=43107,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='EVALUATION_UNEXPECTED_ERROR', index=206, number=43108,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SIGNUP_EVENT_ERROR', index=212, number=46001,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SIGNUP_FLAGGED', index=213, number=46002,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FILETYPE_UNSUPPORTED', index=214, number=46003,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='APP_COUNT_INVALID_MESSAGE', index=215, number=47001,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='APP_COUNT_UPDATE_INCREMENT_FAILED', index=216, number=47002,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='APP_COUNT_REBUILD_FAILED', index=217, number=47003,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='APP_COUNT_INTERNAL_FAILURE', index=218, number=47004,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MP_DOWNLOAD_ERROR', index=219, number=47101,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MP_RESOLVE_DNS_ERROR', index=220, number=47102,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MP_DOWNLOAD_MAX_SIZE_EXCEEDED_ERROR', index=221, number=47103,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MP_IMAGE_DECODE_ERROR', index=222, number=47104,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MP_INVALID_ARGUMENT', index=223, number=47105,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MP_IMAGE_PROCESSING_ERROR', index=224, number=47106,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='USER_CONSENT_FACE', index=225, number=50001,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='WORKER_MISSING', index=226, number=51000,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='WORKER_ACTIVE', index=227, number=51001,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='WORKER_INACTIVE', index=228, number=51002,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='COLLECTOR_MISSING', index=229, number=52000,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='COLLECTOR_ACTIVE', index=230, number=52001,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='COLLECTOR_INACTIVE', index=231, number=52002,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SSO_IDENTITY_PROVIDER_DOES_NOT_EXIST', index=232, number=53001,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TASK_IN_PROGRESS', index=233, number=54001,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TASK_DONE', index=234, number=54002,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TASK_WONT_DO', index=235, number=54003,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TASK_ADD_ANNOTATIONS_FAILURE', index=236, number=54005,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TASK_CONFLICT', index=237, number=54100,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TASK_NOT_IMPLEMENTED', index=238, number=54101,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TASK_MISSING', index=239, number=54102,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LABEL_ORDER_PENDING', index=240, number=55001,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LABEL_ORDER_IN_PROGRESS', index=241, number=55002,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LABEL_ORDER_SUCCESS', index=242, number=55003,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LABEL_ORDER_CANCELED', index=243, number=55004,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LICENSE_ACTIVE', index=244, number=60000,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LICENSE_DOES_NOT_EXIST', index=245, number=60001,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LICENSE_NEED_UPDATE', index=246, number=60002,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LICENSE_EXPIRED', index=247, number=60003,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LICENSE_REVOKED', index=248, number=60004,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LICENSE_DELETED', index=249, number=60005,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LICENSE_VOLUME_EXCEEDED', index=250, number=60006,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PASSWORD_VALIDATION_SUCCESS', index=251, number=61000,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PASSWORD_VALIDATION_FAILED', index=252, number=61001,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PASSWORDPOLICY_INVALID_ARGUMENT', index=253, number=61002,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FEATUREFLAG_CONFIG_NOT_FOUND', index=254, number=62000,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FEATUREFLAG_INVALID_ARGUMENT', index=255, number=62001,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FEATUREFLAG_BLOCKED', index=256, number=62002,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MAINTENANCE_SUCCESS', index=257, number=63000,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MAINTENANCE_FAILED', index=258, number=63001,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_SERVER_ISSUE', index=259, number=98004,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_FETCHING_ISSUE', index=260, number=98005,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_DATABASE_ISSUE', index=261, number=98006,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_UNEXPECTED_TIMEOUT', index=262, number=98009,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_UNEXPECTED_V1', index=263, number=98010,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_UNEXPECTED_PANIC', index=264, number=98011,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_UNEXPECTED_SPIRE', index=265, number=98012,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_REDIS_UNAVAILABLE', index=266, number=98013,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_RESOURCE_EXHAUSTED', index=267, number=98014,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_REDIS_UNCATEGORIZED', index=268, number=98015,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_AWS_UNCATEGORIZED', index=269, number=98016,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_AZURE_UNCATEGORIZED', index=270, number=98017,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CONN_UNCATEGORIZED', index=271, number=99001,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MODEL_UNCATEGORIZED', index=272, number=99002,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INPUT_UNCATEGORIZED', index=273, number=99003,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ANNOTATION_UNCATEGORIZED', index=274, number=99004,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='BILLING_UNCATEGORIZED', index=275, number=99005,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_UNCATEGORIZED', index=276, number=99009,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='BAD_REQUEST', index=277, number=90400,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SERVER_ERROR', index=278, number=90500,
      serialized_options=None,
      type=None),
  ],
