...
_STATUSCODE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TASK_ADD_ANNOTATIONS_FAILURE', index=230, number=54005,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TASK_CONFLICT', index=231, number=54100,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TASK_NOT_IMPLEMENTED', index=232, number=54101,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LABEL_ORDER_PENDING', index=233, number=55001,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LABEL_ORDER_IN_PROGRESS', index=234, number=55002,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LABEL_ORDER_SUCCESS', index=235, number=55003,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LABEL_ORDER_CANCELED', index=236, number=55004,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LICENSE_ACTIVE', index=237, number=60000,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LICENSE_DOES_NOT_EXIST', index=238, number=60001,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LICENSE_NEED_UPDATE', index=239, number=60002,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LICENSE_EXPIRED', index=240, number=60003,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LICENSE_REVOKED', index=241, number=60004,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LICENSE_DELETED', index=242, number=60005,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LICENSE_VOLUME_EXCEEDED', index=243, number=60006,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PASSWORD_VALIDATION_SUCCESS', index=244, number=61000,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PASSWORD_VALIDATION_FAILED', index=245, number=61001,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PASSWORDPOLICY_INVALID_ARGUMENT', index=246, number=61002,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FEATUREFLAG_CONFIG_NOT_FOUND', index=247, number=62000,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FEATUREFLAG_INVALID_ARGUMENT', index=248, number=62001,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_SERVER_ISSUE', index=249, number=98004,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_FETCHING_ISSUE', index=250, number=98005,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_DATABASE_ISSUE', index=251, number=98006,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_UNEXPECTED_TIMEOUT', index=252, number=98009,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_UNEXPECTED_V1', index=253, number=98010,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_UNEXPECTED_PANIC', index=254, number=98011,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_UNEXPECTED_SPIRE', index=255, number=98012,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_REDIS_UNAVAILABLE', index=256, number=98013,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_RESOURCE_EXHAUSTED', index=257, number=98014,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_REDIS_UNCATEGORIZED', index=258, number=98015,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_AWS_UNCATEGORIZED', index=259, number=98016,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_AZURE_UNCATEGORIZED', index=260, number=98017,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CONN_UNCATEGORIZED', index=261, number=99001,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MODEL_UNCATEGORIZED', index=262, number=99002,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INPUT_UNCATEGORIZED', index=263, number=99003,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ANNOTATION_UNCATEGORIZED', index=264, number=99004,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='BILLING_UNCATEGORIZED', index=265, number=99005,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_UNCATEGORIZED', index=266, number=99009,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='BAD_REQUEST', index=267, number=90400,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SERVER_ERROR', index=268, number=90500,
      serialized_options=None,
      type=None),
  ],
