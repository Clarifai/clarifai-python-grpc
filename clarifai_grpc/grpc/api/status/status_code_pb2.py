...
_STATUSCODE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CLUSTER_INTERNAL_FAILURE', index=175, number=43040,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='EXTERNAL_CONNECTION_ERROR', index=176, number=40034,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='QUEUE_CONN_ERROR', index=177, number=41000,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='QUEUE_CLOSE_REQUEST_TIMEOUT', index=178, number=41002,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='QUEUE_CONN_CLOSED', index=179, number=41003,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='QUEUE_PUBLISH_ACK_TIMEOUT', index=180, number=41004,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='QUEUE_PUBLISH_ERROR', index=181, number=41005,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='QUEUE_SUBSCRIPTION_TIMEOUT', index=182, number=41006,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='QUEUE_SUBSCRIPTION_ERROR', index=183, number=41007,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='QUEUE_MARSHALLING_FAILED', index=184, number=41008,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='QUEUE_UNMARSHALLING_FAILED', index=185, number=41009,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='QUEUE_MAX_MSG_REDELIVERY_EXCEEDED', index=186, number=41010,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='QUEUE_ACK_FAILURE', index=187, number=41011,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SQS_OVERLIMIT', index=188, number=41100,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SQS_INVALID_RECEIPT_HANDLE', index=189, number=41101,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SQS_UNKNOWN', index=190, number=41102,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='KAFKA_UNKNOW', index=191, number=41200,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='KAFKA_MISSING_TOPIC', index=192, number=41201,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='KAFKA_ADMIN_ERR', index=193, number=41202,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='KAFKA_CONSUMER_ERR', index=194, number=41203,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='KAFKA_PUBLISHER_ERR', index=195, number=41204,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='USER_CONSENT_FACE', index=230, number=50001,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='WORKER_MISSING', index=231, number=51000,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='WORKER_ACTIVE', index=232, number=51001,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='WORKER_INACTIVE', index=233, number=51002,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='COLLECTOR_MISSING', index=234, number=52000,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='COLLECTOR_ACTIVE', index=235, number=52001,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='COLLECTOR_INACTIVE', index=236, number=52002,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SSO_IDENTITY_PROVIDER_DOES_NOT_EXIST', index=237, number=53001,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TASK_IN_PROGRESS', index=238, number=54001,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TASK_DONE', index=239, number=54002,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TASK_WONT_DO', index=240, number=54003,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TASK_ADD_ANNOTATIONS_FAILURE', index=241, number=54005,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TASK_CONFLICT', index=242, number=54100,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TASK_NOT_IMPLEMENTED', index=243, number=54101,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TASK_MISSING', index=244, number=54102,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LABEL_ORDER_PENDING', index=245, number=55001,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LABEL_ORDER_IN_PROGRESS', index=246, number=55002,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LABEL_ORDER_SUCCESS', index=247, number=55003,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LABEL_ORDER_CANCELED', index=248, number=55004,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LICENSE_ACTIVE', index=249, number=60000,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LICENSE_DOES_NOT_EXIST', index=250, number=60001,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LICENSE_NEED_UPDATE', index=251, number=60002,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LICENSE_EXPIRED', index=252, number=60003,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LICENSE_REVOKED', index=253, number=60004,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LICENSE_DELETED', index=254, number=60005,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LICENSE_VOLUME_EXCEEDED', index=255, number=60006,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PASSWORD_VALIDATION_SUCCESS', index=256, number=61000,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PASSWORD_VALIDATION_FAILED', index=257, number=61001,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PASSWORDPOLICY_INVALID_ARGUMENT', index=258, number=61002,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FEATUREFLAG_CONFIG_NOT_FOUND', index=259, number=62000,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FEATUREFLAG_INVALID_ARGUMENT', index=260, number=62001,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FEATUREFLAG_BLOCKED', index=261, number=62002,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MAINTENANCE_SUCCESS', index=262, number=63000,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MAINTENANCE_FAILED', index=263, number=63001,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='JOB_QUEUED', index=264, number=6400,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='JOB_RUNNING', index=265, number=6401,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='JOB_COMPLETED', index=266, number=6402,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='JOB_FAILED', index=267, number=6403,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='AUTH_MISSING_IDP_ASSOC', index=268, number=65000,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_SERVER_ISSUE', index=269, number=98004,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_FETCHING_ISSUE', index=270, number=98005,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_DATABASE_ISSUE', index=271, number=98006,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_UNEXPECTED_TIMEOUT', index=272, number=98009,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_UNEXPECTED_V1', index=273, number=98010,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_UNEXPECTED_PANIC', index=274, number=98011,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_UNEXPECTED_SPIRE', index=275, number=98012,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_REDIS_UNAVAILABLE', index=276, number=98013,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_RESOURCE_EXHAUSTED', index=277, number=98014,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_REDIS_UNCATEGORIZED', index=278, number=98015,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_AWS_UNCATEGORIZED', index=279, number=98016,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_AZURE_UNCATEGORIZED', index=280, number=98017,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CONN_UNCATEGORIZED', index=281, number=99001,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MODEL_UNCATEGORIZED', index=282, number=99002,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INPUT_UNCATEGORIZED', index=283, number=99003,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ANNOTATION_UNCATEGORIZED', index=284, number=99004,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='BILLING_UNCATEGORIZED', index=285, number=99005,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_UNCATEGORIZED', index=286, number=99009,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='BAD_REQUEST', index=287, number=90400,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SERVER_ERROR', index=288, number=90500,
      serialized_options=None,
      type=None),
  ],
