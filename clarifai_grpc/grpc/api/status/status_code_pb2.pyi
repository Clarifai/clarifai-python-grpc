...
class StatusCode(object):
    ...
    DATABASE_NO_ONGOING_OPERATIONS = typing___cast(StatusCodeValue, 40018)
    DATABASE_LOCKED_BY_ONGOING_OPERATION = typing___cast(StatusCodeValue, 40019)
    ...
    TASK_NOT_VALID_TO_CLOSE = typing___cast(StatusCodeValue, 54100)
