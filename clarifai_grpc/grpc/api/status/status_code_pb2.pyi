...
class StatusCode(object):
    ...
    MODEL_REFERENCE_INVALID_ARGUMENT = typing___cast(StatusCodeValue, 21400)
    MODEL_EXAMPLE_INPUT_INVALID_ARGUMENT = typing___cast(StatusCodeValue, 21420)
    ...
    DATA_DUMP_UNEXPECTED_ERROR = typing___cast(StatusCodeValue, 25155)
    ...
    MODULE_DOES_NOT_EXIST = typing___cast(StatusCodeValue, 25300)
    MODULE_PERMISSION_DENIED = typing___cast(StatusCodeValue, 25301)
    MODULE_INVALID_ARGUMENT = typing___cast(StatusCodeValue, 25302)
    MODULE_INVALID_REQUEST = typing___cast(StatusCodeValue, 25303)
    ...
    REQUEST_CANCELED_BY_USER = typing___cast(StatusCodeValue, 40037)
    ...
    DATATIER_CONN_ERROR = typing___cast(StatusCodeValue, 47201)
    ...
    COLLECTOR_POST_INPUT_FAILED = typing___cast(StatusCodeValue, 52003)
    ...
    DATASET_VERSION_PENDING = typing___cast(StatusCodeValue, 64005)
    DATASET_VERSION_IN_PROGRESS = typing___cast(StatusCodeValue, 64010)
    DATASET_VERSION_READY = typing___cast(StatusCodeValue, 64015)
    DATASET_VERSION_FAILURE = typing___cast(StatusCodeValue, 64020)
    DATASET_VERSION_UNEXPECTED_ERROR = typing___cast(StatusCodeValue, 64025)
    JOB_QUEUED = typing___cast(StatusCodeValue, 64000)
    JOB_RUNNING = typing___cast(StatusCodeValue, 64001)
    JOB_COMPLETED = typing___cast(StatusCodeValue, 64002)
    JOB_FAILED = typing___cast(StatusCodeValue, 64003)
    AUTH_MISSING_IDP_ASSOC = typing___cast(StatusCodeValue, 65000)
